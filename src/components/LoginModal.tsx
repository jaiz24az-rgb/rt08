    ...
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-sm p-6 relative overflow-hidden shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/65 text-[10px] text-slate-400 leading-relaxed font-mono">
            💡 <strong className="text-sky-400 font-bold">AKUN PENGURUS RT DEFAULT:</strong><br/>
            🟢 <strong className="text-sky-305">Admin (Ketua RT):</strong><br/>
            Username: <span className="text-slate-200 font-bold">admin</span> | PIN: <span className="text-slate-200 font-bold">123456</span><br/>
            🟢 <strong className="text-emerald-400">Bendahara (Pencatat):</strong><br/>
            Username: <span className="text-slate-200 font-bold">bendahara</span> | PIN: <span className="text-slate-200 font-bold">654321</span>
          </div>
